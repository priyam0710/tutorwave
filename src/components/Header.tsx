      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="flex items-center justify-between h-16 md:h-[68px]">
            ...
            >
              <span
                className={`block w-5 h-0.5 bg-[#0D1118] transition-all duration-300 ${
        ...
        <div className="flex flex-col h-full p-6 pt-5">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2.5">
              <div className="relative w-8 h-8 rounded-xl overflow-hidden bg-white border border-[#E5E7EB]">
                <Image
                  src="/assets/images/app_logo.png"
                  alt="TutorWave logo"
                  width={32}
              ...
              <span
                className="font-sans font-bold text-base text-[#0D1118]"
