...
export const subjects: Subject[] = [
  {
    ...
    boards: ['CBSE', 'ICSE', 'IIT-JEE'],
    category: 'core',
    relatedSubjects: ['physics', 'computer-science'],
    seoTitle: 'Mathematics Home Tutor in Delhi NCR — TutorWave',
    seoDescription: 'Find experienced Mathematics tutors for Class 1–12 in Delhi NCR. CBSE, ICSE and IIT-JEE preparation. Home and online classes available.',
    faqs: [
      { question: 'Which classes do you offer Mathematics tutoring for?', answer: 'We offer Mathematics tutoring from Class 1 through Class 12, including IIT-JEE preparation for Class 11–12 students.' },
      { question: 'Can tutors help with board exam preparation?', answer: 'Yes. Our tutors are experienced with CBSE and ICSE board patterns and can tailor sessions to exam requirements.' },
  ...
  },
  {
    ...
    slug: 'science',
    icon: '🔬',
    description: 'Comprehensive Science tutoring for Class 1–10 covering Physics, Chemistry and Biology concepts with practical understanding.',
    classes: ['Class 1–5', 'Class 6–10'],
    boards: ['CBSE', 'ICSE'],
    category: 'core',
    relatedSubjects: ['physics', 'chemistry', 'biology'],
    seoTitle: 'Science Home Tutor in Delhi NCR — TutorWave',
    seoDescription: 'Find experienced Science tutors for Class 1–10 in Delhi NCR. CBSE and ICSE. Home and online classes available.',
    faqs: [
      { question: 'What does Science tutoring cover for Class 6–10?', answer: 'Science tutoring covers Physics, Chemistry and Biology topics as per the CBSE or ICSE curriculum for each class.' },
