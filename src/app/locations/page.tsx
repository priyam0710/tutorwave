...
const locationMeta: Record<string, { tagline: string }> = {
  delhi: {
    tagline: 'South Delhi, Dwarka, Rohini & more',
  },
  noida: {
    tagline: 'Sectors 18, 50, 62, 76, 100 & more',
  },
  'greater-noida': {
    tagline: 'Greater Noida West, Knowledge Park & more',
  },
  ghaziabad: {
    tagline: 'Indirapuram, Vaishali, Raj Nagar & more',
  },
  gurugram: {
    tagline: 'DLF, Sohna Road, Golf Course Road & more',
  },
  faridabad: {
    tagline: 'Sector 15, 21, NIT Faridabad & more',
  },
};
    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="pt-28 pb-14 bg-[#F8FAFC] border-b border-[#E5E7EB]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <nav
            className="flex items-center gap-2 text-sm text-[#6B7280] mb-6"
          ...
          <div className="max-w-2xl">
            ...
            <h1
              className="text-4xl sm:text-5xl font-bold text-[#0D1118] mb-4 leading-tight"
            ...
            <p className="text-lg text-[#6B7280] leading-relaxed">
              TutorWave has a growing tutor network across Delhi, Noida,
              Greater Noida, Ghaziabad, Gurugram and Faridabad. Find a
              verified tutor near your home.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {locations.map((location) => {
              const meta = locationMeta[location.slug] ?? {
                tagline: location.areas.slice(0, 2).join(', '),
              };
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-5">
                    {location.areas.slice(0, 4).map((area) => (
                      <span
                        key={area}
                        className="text-xs px-2.5 py-1 bg-[#F8FAFC] border border-[#E5E7EB] text-[#6B7280] rounded-full"
                      >
                        {area}
                      </span>
                    ))}
      ...
      <section className="py-10 bg-[#F8FAFC] border-t border-[#E5E7EB]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
          <p className="text-[#6B7280] text-sm leading-relaxed">
            Don&apos;t see your area listed? Submit your tuition requirement
            and mention your location. Our team will work to find suitable
            tutor options near you.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white border-t border-[#E5E7EB]">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
          <h2
            className="text-3xl font-bold text-[#0D1118] mb-4"
          ...
          <p className="text-[#6B7280] mb-8 leading-relaxed">
            Share your location and requirement. TutorWave will help identify
            suitable tutor options in your area.
          </p>
